...
public class SolutionXFileDiscoveryStrategy : IDirectoryDiscoveryStrategy
{
    public void DiscoverInDirectory(string repositoryPath, string directoryPath, List<SolutionInfo> results)
    {
        foreach (var filePath in Directory.GetFiles(directoryPath, "*.slnx", SearchOption.TopDirectoryOnly))
        {
